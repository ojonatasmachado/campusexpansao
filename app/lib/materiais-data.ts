...
export type Familia = "ministrar" | "liderar";
export type Colecao = "retiro" | "conferencia";
...
export const INFANTIL_ESTANTES: Estante[] = [
...
export const ESTANTE_MAP = Object.fromEntries(ESTANTES.map(e => [e.key, e]));
export const ESTANTES_MINISTRAR = ESTANTES.filter(e => e.familia === "ministrar" && !e.key.startsWith("infantil-"));
export const ESTANTES_LIDERAR   = ESTANTES.filter(e => e.familia === "liderar");
export const INFANTIL_CHIP = { key: "infantil", label: "Infantil", accent: "wheat" as AccentKey };
export const L2_MINISTRAR = [INFANTIL_CHIP, ...ESTANTES_MINISTRAR];
...
export const MATERIAIS: Material[] = [
  // ── ADOLESCENTES ──────────────────────────────────────────────────────────
  {
    ...
    preco: "R$ 47", hotmartUrl: "", colecoes: [],
  ...
  },
  {
    ...
    preco: "R$ 67", hotmartUrl: "", colecoes: [],
  ...
  },
  {
    ...
    preco: "R$ 37", hotmartUrl: "", colecoes: ["retiro"],
  ...
  },
  {
    ...
    preco: "R$ 47", hotmartUrl: "", colecoes: ["retiro"],
  ...
  // ── JUNIORES ──────────────────────────────────────────────────────────────
  {
    ...
    meta: { mensagens: 5, paginas: 40, formatos: ["PDF", "Editável"] },
    preco: "R$ 37", hotmartUrl: "", colecoes: [],
  ...
  // ── IGREJA TODA ───────────────────────────────────────────────────────────
  {
    ...
    preco: "R$ 97", hotmartUrl: "", colecoes: [],
  ...
  },
  {
    ...
    meta: { mensagens: 6, paginas: 52, formatos: ["PDF", "Editável", "Slides"] },
    preco: "R$ 67", hotmartUrl: "", colecoes: ["conferencia"],
  ...
  },
  {
    ...
    preco: "R$ 27", hotmartUrl: "", colecoes: [],
  ...
  },
  {
    ...
    preco: "R$ 39", hotmartUrl: "", colecoes: [],
  ...
  },
  {
    ...
    preco: "R$ 41", hotmartUrl: "", colecoes: [],
  ...
  },
  {
    ...
    preco: "R$ 43", hotmartUrl: "", colecoes: [],
  ...
  // ── MONTAR EVENTO ─────────────────────────────────────────────────────────
  {
    ...
    preco: "R$ 147", hotmartUrl: "", colecoes: ["retiro"],
  ...
  },
  {
    ...
    meta: { paginas: 80, formatos: ["PDF", "Editável"] },
    preco: "R$ 127", hotmartUrl: "", colecoes: ["conferencia"],
  ...
  },
  {
    ...
    meta: { paginas: 60, formatos: ["PDF", "Editável"] },
    preco: "R$ 97", hotmartUrl: "", colecoes: ["conferencia"],
