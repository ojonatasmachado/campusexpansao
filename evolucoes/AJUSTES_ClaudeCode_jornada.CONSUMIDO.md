...
> de catálogo/filtros/auto-Netflix). Aplique as mudanças abaixo mantendo a identidade
> visual da CE.X (paleta Oliva #7A9E3F, Cream #EDE6D3, Ink #0E110D, fonte Inter, logo
> "CE.X"). Consulte `CEX_BrandBook_v3.html` para tokens e uso da marca.
...
- **Topo do miolo:** marca de nível `◆ FUNDAÇÃO` (mono, caixa-alta, cor de acento) à
  ...
  escura `#0E110D`, mono caixa-alta, cantos 4px). Esse selo sólido é o sinal de "ativo" —
  é o que impede o card de parecer desabilitado.
- **Base do miolo:** título do curso (Inter 800, ~30px, cream) + 1 linha de descrição
  (Inter 400, ~14px, cor areia `#C9BFA0`).
- **Rodapé:** meta `● X semanas · Mentoria inclusa` (mono, com bolinha na cor de acento)
  na linha de cima; embaixo, `ETAPA 0N` (mono, cor de acento) à esquerda e `Detalhes →`
...
cada um uma fileira com sua marca `◆` e seu acento:

| Nível | Acento | Cursos |
|---|---|---|
| **Fundação** | Ocre `#C0934E` | 01 Fundamentos da Estrutura · 04 Gestão de Equipe |
| **Liderança** | Argila `#B07355` | 02 Formação de Líderes · 06 Liderança e Descanso |
| **Multiplicação** | Oliva `#7A9E3F` | 03 Discipulado Intencional · 05 Plantação de Igrejas |
...
- Não inventar cores fora da paleta CE.X nem trocar a fonte Inter.
- Não deixar nenhum `—`/`–` renderizado. Não remover `·` nem `→`.
- Não usar emojis. Marcas permitidas: `◆ ◇ → →`.
