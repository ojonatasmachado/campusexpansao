...
function newItem(type) {
  ...
  if (type === 'material') return { ...base, family: 'Para ministrar', shelf: 'Juniores', code: '', messages: null, pages: null, format: 'PDF', formatos: [], price: 0, hotmart: '', accent: acc({ family: 'Para ministrar', shelf: 'Juniores' }), buyClicks: 0, model: 'A', big: null, bigLabel: 'mensagens', messageList: [], contents: [], paraQuem: '', beneficios: ['Editável e pronto pra aplicar na sua igreja', 'White-label CE.X: coloque a marca do seu ministério'], tags: [], faq: [] };
  if (type === 'curso') return { ...base, level: 'Fundação', etapa: 1, totalEtapas: 6, weeks: 4, mentoria: true, aoVivo: true, mentor: '', accent: acc({ level: 'Fundação' }), waitlist: 0, ementa: ['', '', '', ''], paraQuem: '', proximaTurma: 'Próxima turma: a definir' };
