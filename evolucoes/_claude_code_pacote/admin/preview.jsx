      ...
      <div className="pv-detail-body">
        ...
        {isMaterial && (
          <>
            ...
            {item.depoimento && item.depoimento.texto && (
              <div style={{ borderLeft: `2px solid ${item.accent}`, paddingLeft: 14, margin: '20px 0', fontSize: 13, color: 'var(--light)', lineHeight: 1.6 }}>
                ...
                {item.depoimento.autor && <div style={{ fontFamily: 'var(--mono)', fontSize: 11, color: 'var(--muted)', marginTop: 8 }}>— {item.depoimento.autor}</div>}
              </div>
            )}
